<x-app-layout>
    <div class="md:grid md:grid-cols-1">
        <h2 class="text-4xl font-extrabold text-black pl-10">Cargar dominio</h2>
    </div>
    <form method="POST" action="{{ route('dominio.store') }}" id="idFormulario">
        @csrf
            ...
            <div class=" bg-white rounded shadow-lg p-4 ">
                <div class="grid  text-sm grid-cols-1 lg:grid-cols-2">
                    <div class="text-gray-600 col-span-2">
                        <p class="font-medium text-lg">Información del dominio</p>
                        ...
                        <div class="grid gap-2 gap-y-1 text-sm grid-cols-1 md:grid-cols-5">
                            <div class="md:col-span-5">
                                ...
                                <div class="md:col-span-3 md:row-span-3">
                                    ...
                                    <textarea name="observaciones" id="observaciones" class="h-20 border mt-1 rounded px-4 w-full bg-gray-50" value=""
                                        placeholder="Ingrese las observaciones del dominio"></textarea>
                                ...
                                <div class="grid grid-cols-3">
                                    <div class="col-span-1 md:row-span-3 justify-center place-items-center">
                                        ...
                                        <select name="cliente" id="idCliente" class="rounded-lg">
                                    ...
                                    <div class="col-span-1 md:row-span-3 justify-center place-items-center">
                                        ...
                                        <select name="dueño" id="idDueño" class="rounded-lg">
                                    ...
                                    <div class="col-span-1 md:row-span-3 justify-center place-items-center">
                                        ...
                                        <select name="titular" id="" class="rounded-lg">
